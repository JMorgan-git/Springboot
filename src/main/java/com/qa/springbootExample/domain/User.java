...
// LOMBOK removes the need for the following commented out code with @noargsconstructor
...
// LOMBOK also removes the need for the following commented out code with @data
